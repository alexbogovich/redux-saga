...
export const fireBaseSignUp = "https://www.googleapis.com/identitytoolkit/v3/relyingparty/signupNewUser?key=AIzaSyAqBAskHQJp11DVBkqtMPRyQJ4-XWM94ec"
export const fireBaseSignIn = "https://www.googleapis.com/identitytoolkit/v3/relyingparty/verifyPassword?key=AIzaSyAqBAskHQJp11DVBkqtMPRyQJ4-XWM94ec"

export function getDateByAdditionalTime(time) {
...
export function* checkAuthTimeoutSaga(action) {
  yield call(delay, action.expirationTime)
  yield put(logout())
}
...
export function* authUserSaga(action) {
  ...
  try {
    ...
    const expirationDate = yield call(getDateByAdditionalTime, response.data.expiresIn)
